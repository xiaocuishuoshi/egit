...
<form method="post" action="user/update.do"  onsubmit="return validateSubmitForm(this)">
		<table class="table table-bordered">				
			...
			<tr>
				<th>手机号：</th>
				<td>
					<input type="text" name="mobilePhoneNumber"  onChange="checkMob(this);"  value="${requestScope.u.mobilePhoneNumber }"  class="easyui-validatebox"  data-options="validType:['mPhone']"   maxlength="11" />
				</td>
			</tr>
			<tr>
				<th>部门：</th>

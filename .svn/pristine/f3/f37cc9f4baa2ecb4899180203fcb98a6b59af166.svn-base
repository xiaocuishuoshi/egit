...
<body class="loginPageBody">
	...
	<div class="LoginWrapbg ">
		...
		<div class="copyright">
			<div class="center">PSSDSS 2014-2015  <a href="<fmt:message key="app.name.url" bundle="${commonBundle}"/>" target="_blank"><fmt:message key="app.name" bundle="${commonBundle}"/></a></div>
		</div>
	</div>
</body>
</html>

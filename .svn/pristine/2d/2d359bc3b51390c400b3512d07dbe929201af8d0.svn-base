...
public class SerialNumberUtil {
	...
	public static void main(String[] args) {
		...
		String key = makeKey("hcdx", "hcdx20180520", "2018-05-20", "2018-09-20", "123");
		System.out.println("key:"+key);
		long start = DateUtil.string2Date("2018-05-20").getTime();
		
		long end = DateUtil.string2Date("2018-09-12").getTime();
		Boolean flag = verificationkey("hcdx", "hcdx20180520", start, end, "123", key);

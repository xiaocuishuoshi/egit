...
public class SyUsers implements java.io.Serializable {
	...
	@Pattern(regexp="^\\w{3,18}$",message="账号只能由数字、字母或者下划线组成，长度在3-18之间。")
	...
	@Length(min=0,max=50,message="地址信息")
	...
	public SyUsers(String userName, String userPassword, Short userStatus,
			String deptId, String trueName, Short userSex, String registerUid,String orgId,String cid) {
	...
	public SyUsers(String userName, String userPassword,
			...
			Short userSex, String registerUid,String mobilePhoneNumber,String orgId) {
		this.userName = userName;
		this.userPassword = userPassword;

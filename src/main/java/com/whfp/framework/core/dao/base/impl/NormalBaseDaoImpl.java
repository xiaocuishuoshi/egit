package com.whfp.framework.core.dao.base.impl;
...
import com.whfp.framework.core.dao.base.Condition;
import com.whfp.framework.core.dao.base.CustomerHashMap;
import com.whfp.framework.core.dao.base.INormalBaseDao;
import com.whfp.framework.core.dao.base.PageBean;
import com.whfp.framework.core.dao.enums.OrderType;
import com.whfp.framework.core.dao.exception.WDaoException;
import com.whfp.framework.core.dao.hibernate.DynamicStatementBuilderImpl;
import com.whfp.framework.core.dao.hibernate.IDynamicStatementBuilder;
import com.whfp.framework.core.dao.hibernate.StatementTemplate;
import com.whfp.framework.core.dao.utils.CountSqlParser;
import com.whfp.framework.core.dao.utils.FormatUtil;
import com.whfp.framework.core.dao.utils.ValidateUtil;
...
@Repository("normalBaseDaoImpl")
public class NormalBaseDaoImpl extends HibernateDaoSupport implements INormalBaseDao {
    private static final String REG = "(?:')|(?:--)|(/\\*(?:.|[\\n\\r])*?\\*/)|"
            + "(\\b(select|update|and|or|delete|insert|trancate|char|into|substr|ascii|declare|exec|count|master|into|drop|execute)\\b)";
    private static   Pattern sqlPattern = Pattern.compile(REG, Pattern.CASE_INSENSITIVE);
    private static final Logger logger = LoggerFactory.getLogger(NormalBaseDaoImpl.class);

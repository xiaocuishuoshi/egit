...
--%>
	...
	<form  action="org/add.do"   method="post"   onsubmit="return validateSubmitForm(this)">
		...
		<div class="divider"></div>
		 <table class="table table-nobordered ">	
		   ...
		   <tr>
		    	...
		    	<td>
		     		<input type="text" name="orgSort" class="easyui-numberbox" required="true"  min="1" max="999" maxlength="3"/>
		    ...
		    <tr>
				 <th>部门名称：</th>
				 <td>
					 <input type="text" name="orgName" class="easyui-validatebox"  required="true"   data-options="validType:['length[1,50]']"  maxlength="50" />
				 </td>
		   </tr>
		    <tr>
				<th>电话：</th>
				<td>
					<input type="text" name="orgPhone" maxlength="255" />
		  	...
		  	<tr>
				<th>传真：</th>
				<td>
					<input  type="text" name="orgFax"  maxlength="255"  class="easyui-validatebox" />
			 ...
			 <tr>
				<th>地址：</th>
				<td>
					<textarea  name="orgAddress"  rows="2" maxlength="100"></textarea>
				</td>
			</tr>
					...
					<a href="org/lookUpPage.do?type=3" lookupGroup="org"  title="上级部门查询">
						...
						<c:choose>
							<c:when test="${empty param.superId }">
								<input  type="text" value="顶级部门"  readonly="readonly"  toName="org.orgName"  class="easyui-validatebox" required="true"/>
							</c:when>
							<c:otherwise>
								<input  type="text" value="<my:outDeptName id="${param.superId }" />"  readonly="readonly"  toName="org.orgName"  class="easyui-validatebox" required="true"/>
							</c:otherwise>
						</c:choose>
					
					</a>
					<input type="hidden" name="superId"  toName="org.id"  value="<c:out value="${param.superId }" default="0"/>" />
		   ...
		   <tr>
			  <th>备注：</th>
			  <td>
					<textarea  name="orgDesc"  rows="2" maxlength="200"></textarea>
			  </td>
		  </tr>

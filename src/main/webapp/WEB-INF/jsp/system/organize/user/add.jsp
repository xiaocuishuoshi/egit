...
<script type="text/javascript">
  function checkMob(obj){
  	  ...
  	  if(value!=''){ 
  	  	  ...
  	  	  if(v!='189'&&v!='153'&&v!='133'&&v!='177'&&v!='180'&&v!='181'&&v!='173'&&v!='199'){
  	  	    	obj.value='';
  	  	    	alert('您输入的非电信手机号码，请重新输入！');
...
<div style="width: 600px;margin: 0 auto;" >
	...
	<form name="formadd" action="user/add.do" beforeCallback="encryptePassword"	 onsubmit=" return validateSubmitForm(this)" method="post">
		  <table class="table table-bordered ">
			   <tr>
				...
				<tr>
					<th>手机号：</th>
					<td>
						<input type="text" name="mobilePhoneNumber"  onChange="checkMob(this);" class="easyui-validatebox"  data-options="validType:['mPhone']"   maxlength="11" />
					</td>
				</tr>
				<tr>
					<th>管控部门：</th>

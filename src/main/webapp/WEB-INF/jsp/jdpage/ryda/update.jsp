...
<input type="hidden" name="jdCjsj" class="easyui-validatebox"
					 value="${requestScope.jd.jdCjsj}"/>
...
<input type="hidden" name="jdSjid" class="easyui-validatebox"
		...
		value="${requestScope.jd.jdRybh}"	 />
				...
				<td rowspan="4" id="tp">
					<div><img id="upview" src="<%= path %>/${requestScope.jd.jdRyxp}" style="float:left; width:130px; height:150px;">
				<input id="upload" type="file" name="jdRyxpFile"
					class="easyui-validatebox" style="float:left;width: 120px;"></div>
				</td>
			</tr>

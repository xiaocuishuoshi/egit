...
<div style="width:95%;margin: 0 auto ;" >
	...
	<form action="tzs/add.do" enctype="multipart/form-data" onsubmit="return validateSubmitForm(this)"
		method="post">
	<table class="table table-bordered " border="1">
			<tr>
				...
				<td>
					...
					<input type="hidden" name="tzsjsrid"  toName="user.id" />
				</td>
			</tr>
			<tr>
				<td style="padding-top:100px; padding-left:40px;white-space: nowrap;">通知书内容：</td>
				<td  colspan="3">
					<textarea  name="tzsnr"  rows="5"  class="editor"  style="width:600px; height:300px;" ></textarea>
				</td>
			</tr>
	</table>
